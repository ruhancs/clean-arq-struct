...
type CreateOrderResponse struct {
	...
	Price      float32 `protobuf:"fixed32,1,opt,name=price,proto3" json:"price,omitempty"`
	Tax        float32 `protobuf:"fixed32,2,opt,name=tax,proto3" json:"tax,omitempty"`
	FinalPrice float32 `protobuf:"fixed32,3,opt,name=final_price,json=finalPrice,proto3" json:"final_price,omitempty"`
}
...
var file_internal_infra_grpc_protofiles_order_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x74, 0x61, 0x78, 0x22, 0x5e,
	...
	0x61, 0x78, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x74, 0x61, 0x78, 0x12, 0x1f, 0x0a,
